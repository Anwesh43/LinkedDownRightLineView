...
class DownRightLineView(ctx : Context) : View(ctx) {
    ...
    data class DownRightLine(var i : Int) {

        private var curr : DRLNode = DRLNode(0)
    ...
    companion object {
        ...
        fun create(activity : Activity) : DownRightLineView {
            val view : DownRightLineView = DownRightLineView(activity)
